...
from verl.workers.rollout.async_server import AsyncLLMServerManager, PartialRolloutAsyncLLMServerManager
...
def init_async_rollout_iter_manager(config: DictConfig, scheduler_kwargs: Dict[str, Any] = None) -> AsyncLLMServerManager:
    # make openai client happy
    os.environ["no_proxy"] = ""
    os.environ["http_proxy"] = ""
    os.environ["https_proxy"] = ""
    ...
    # =========================== 2. Create AsyncLLMServerManager  ===========================
    async_rollout_manager = PartialRolloutAsyncLLMServerManager(
        config=config.actor_rollout_ref,
        worker_group=actor_rollout_wg,
        scheduler_kwargs=scheduler_kwargs,
    )
